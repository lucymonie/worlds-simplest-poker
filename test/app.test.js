describe("Tests that poker game", function() {
  it('can create a new state object with the number of players and cards set', function () {
    let newState = getState(2, 5);
